# Scatter plots for 302 REALZ DATA (see m1_160comps_15randsd.py for 200 realz)
...
if __name__ == '__main__':
    ...
    for i in range(0,num_random_seeds):
        ...
        #----------------------------------------;
        model1     = tf.keras.models.load_model(path_fl_sav + "m1_NoMixup_v1") #Load saved DNN model (encoded)
        model1.summary() #Print dnn model summary
        print(model1.layers[-1].output_shape[1:]) #Print output shape (no. of neurons in out-layer)
        #
