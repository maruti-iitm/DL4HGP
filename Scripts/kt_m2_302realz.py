...
#
# Hyperparameter tuning for encoded DNNs (Pre-computed Mixup; 396,210 training samples)
...
if __name__ == '__main__':
    ...
    for i in range(0,num_random_seeds):
        ...
        directory            = path + "Python_Scripts/302_DL_Scripts/kt_m2_15randsd/" + \
        ...
        tuner.search(x = train_pots_mixup, 
                     ...
                     verbose = verbose) #Perform search
